...
app = Flask(__name__)
app.config['UPLOAD_EXTENSIONS'] = ['.mp4'] # decides what FORMAT media that user can upload to server
...
def edit_video():
    ...
    if video1_filename != '' and video2_filename != '': # checks if the user inserted a video
        ...
        uploaded_video.save(video1_filename) # takes uploaded video from frontend to saved in python project file
