...
def kmeans(link1, link2):
    ...
    for label in (student_cluster):
        ...
        os.chdir(r'C:\Users\bobby\Downloads\finafina\coach')
        for file in os.listdir(r'C:\Users\bobby\Downloads\finafina\coach'):
            ...
            for cluster_index in cluster_nums:              #0
                if(file == img_path and cluster_index == predict):
                    ...
                    shutil.copy2(file,r'C:\Users\bobby\Downloads\finafina\images\vid1')
                    cluster_nums.remove(cluster_index)
        img1 = Image.open(f'coach{nearest}.jpg')

        os.chdir(r'C:\Users\bobby\Downloads\finafina\student')
        for file in os.listdir(r'C:\Users\bobby\Downloads\finafina\student'):
            img_path = f'student{index_student}.jpg'
            if(file == img_path and isInClusterNums):
                shutil.copy2(file,r'C:\Users\bobby\Downloads\finafina\images\vid2')
        img2 = Image.open(f'student{index_student}.jpg')
        
        
        if isInClusterNums:
            os.chdir(r'C:\Users\bobby\Downloads\finafina\images\highlighted_differences')
            diff = ImageChops.difference(img1,img2)
            diff = diff.save(f'highlight{num}.jpg')
            num+=1

            
        os.chdir(r'C:\Users\bobby\Downloads\finafina')
